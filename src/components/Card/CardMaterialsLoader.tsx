...
export class CardMaterialsLoader{
    ...
    load = () => {
        ...
        const alphaLogoURL:string = (this.isHorizontal) ? 'jpg/logo-left.jpg' : 'jpg/enso_left_h.jpg'
        const betaInsideURL:string = (this.isHorizontal) ? 'jpg/sky3.jpg' : 'jpg/panel_bottom.jpg'
        const betaLogoURL:string = (this.isHorizontal) ? 'jpg/logo-right.jpg' : 'jpg/enso_bottom_v.jpg'
